...
基于[EzyAssistanceSS](https://github.com/KiraEzy/EzyAssistanceSS)进行修改，感谢开源。目前仅适配简中官服。
为《铃兰之剑》提供刷图、爬塔、清体力和日常领取等自动化辅助。
